...
{\bf Describe how the postprocessing will be done}
...
in Section~\ref{sec:tasks}. The milestones in Table~\ref{tab:milestones} are directly orrelated
...
\midrule
\multirow{5}{*}{SFR} & I & A & Mesh convergence studies for clusters of bundles & May 2022 \\
& & B & Complete full-core Nek5000/RS CFD mesh and models & July 2022\\
& & C & Preliminary tests of full-core CFD model & Sept 2022\\
\\
& II & A & Complete full-core Pronghorn low-resolution models & Nov 2022 \\
& & B & Preliminary tests of full-core low-resolution model & Dec 2022\\
& III & \\
& IV & \\
& V & \\
\midrule
...
For the SFR modeling, Stage I encompasses model setup and preliminary testing for
...
determine appropriate time step sizes 

appropriate time step sizes, 

CFL-constrained time step sizes,


These milestones, their relationship to the project goals, and the research significance
of the specific tasks undertaken, have been described in Section \ref{sec:tasks}. 
