...
simulations} (Figure~\ref{fig:350k}) coupled with advanced instrumented separate-effect experiments to
...
\includegraphics[width=0.93\textwidth]{../figs/pebble01.png}
 \caption{\label{fig:350k} High fidelity reactor simulations of turbulent flow performed on OLCF/Summit:
  ...
  $E$=98,782,067 elements of order $N=8$. We emphasize the difference in size enabled by nekRS and Summit versus Mira.}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
