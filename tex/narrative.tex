...
\item Develop full-core meshes and test at scale to ensure high quality. Mesh
    ...
    geometries. Develop full-core models based on the ABR specifications \cite{abr}.  
...
milestones shown in Section 4, where additional information is provided with
respect to required computing resources.
