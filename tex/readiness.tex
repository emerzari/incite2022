...
{\setlength{\unitlength}{1.0in} \begin{picture}(3.000,0.600)(-.2,0)
  \includegraphics[scale=0.45]{figs/libp_kernels.png}
\end{picture}} \caption{\label{fig:roof} 
libParanumal
Poisson-operator kernel development (iterations $K=1,\dots,10$) vs.
polynomial order, $N$   \cite{ceed_pb_paper_2020}.
\vspace*{-.2in} }
